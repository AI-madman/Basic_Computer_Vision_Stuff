...
int main() {
	...
	std::vector<cv::KeyPoint> Keypoints1; // This will store the keypoint locations for the first image
	std::vector<cv::KeyPoint> Keypoints2; // This will store the keypoint locations for the seconed image
	std::vector<cv::DMatch> matches;

	// This Section of Code deals with reading in the two inital images.
	cv::Mat img1 = cv::imread("C:\\Users\\adbg044\\Desktop\\Visual Odometry papers\\Assets\\IMG_20191014_111003.jpg", 0);
	ImageLoadingChecker(img1);
	cv::Mat img2 = cv::imread("C:\\Users\\adbg044\\Desktop\\Visual Odometry papers\\Assets\\IMG_20191014_111011.jpg", 0);
